...
public class RandomDataGenerator {
	...
	public static void generateCustomerDataUMREX(String registrationType) {
		...
		MainUtil.dictionary.put("CUSTOMER_NAME", "TEST AUTO "+randomChar("randomchar#5"));
		...
		MainUtil.dictionary.put("CUSTOMER_ADDRESS", "TEST ADDRESS");
		MainUtil.dictionary.put("CUSTOMER_CITY", "KUALA LUMPUR");
		MainUtil.dictionary.put("CUSTOMER_STATE", "KUALA LUMPUR");
		MainUtil.dictionary.put("CUSTOMER_POSTCODE", "51100");
		MainUtil.dictionary.put("CUSTOMER_EMAIL", "AUTOTEST"+randomChar("randomnumber#3")+"@UM.COM");
		MainUtil.dictionary.put("CUSTOMER_NUMBER", "601661"+randomChar("randomnumber#5"));
	}
}
