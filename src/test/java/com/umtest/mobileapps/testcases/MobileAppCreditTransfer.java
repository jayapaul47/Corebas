...
public class MobileAppCreditTransfer extends DriverFactory {
	...
	private static Logger logger = LogManager.getLogger(MobileAppCreditTransfer.class);
	...
	public void creditTransfer(String category, String Sender_msisdn, String Receiver_msisdn, String transfer_amount) {
		...
		try {
			...
			/*	Verify Selfcare*/
				...
				mobileAppLoginFuncs = new MobileAppLoginFuncs(driver);
				mobileAppLoginFuncs.loginMobileApp(MainUtil.dictionary.get("MSISDN"));
				MobileAppUtilFuncs mobileAppUtilFuncs2 = new MobileAppUtilFuncs(driver);
				mobileAppUtilFuncs2.verifyCreditShareBalance();
